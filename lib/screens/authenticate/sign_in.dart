...
class _SignInState extends State<SignIn> {
  ...
  Widget build(BuildContext context) {
    /// Kiểm tra
    /// nếu loading = true thì hiện Loading page
    /// còn loading = false thì hiện lại page cũ - Scafford
    return loading
        ? const Loading()
        : Scaffold(
              ...
              child: Form(
                ...
                child: Column(
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () async {
                        /// Trước khi xác thực UserCredential, bật loading page lên
                        /// và tự động chuyển sang Home page nếu Credential đúng
                        /// hoặc tự tắt Loading page sau khi báo Credential sai
                        setState(() {
                          //Bật loading page
                          loading = true;
                        });
